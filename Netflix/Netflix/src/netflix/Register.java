...
*/
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        if(jTextField_Cpassword.getText().equals(jTextField_Password.getText())) {
            try {
                String date = jTextField_YYYY.getText() + jTextField_MM.getText() + jTextField_DD.getText();
                String query = "insert into Kullanıcı(kullaniciAdi,isimKullanici,kullaniciEmail,kullaniciSifre,kullaniciDogum) values (?,?,?,?,?)";
                ...
                pst.setString(4, jTextField_Password.getText());
                ...
                JOptionPane.showMessageDialog(null,"Bu kullanıcı adı veya Email kullanılıyor!");
            ...
            JOptionPane.showMessageDialog(null,"Şifreler birbiriyle uyumlu değil!");
        }
